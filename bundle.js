...
/* harmony import */ var _model_task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model-task.js */ "./src/js/model-task.js");
...
class API {
  ...
  getTasks() {
    return this._load({url: `tasks`})
      .then(API.toJSON)
      .then(_model_task_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseTasks);
  }
  ...
  createTask({task}) {
    return this._load({
      ...
      .then(API.toJSON)
      .then(_model_task_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseTask);
  }
...
/***/ "./src/js/components/abstract-component.js":
/*!*************************************************!*\
  !*** ./src/js/components/abstract-component.js ***!
  \*************************************************/
/*! exports provided: default */
...
class AbstractComponent {
  ...
  _makeFormattedDate(dateValue) {
    ...
    return moment__WEBPACK_IMPORTED_MODULE_1___default()(dateTs).format(`DD MMMM, YYYY`);
  }
}
...
/***/ "./src/js/components/board-container.js":
/*!**********************************************!*\
  !*** ./src/js/components/board-container.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component.js */ "./src/js/components/abstract-component.js");


class BoardContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Filters extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  static getMockElement() {
    return Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(`<section class="main__filter filter container">
      <input
        type="radio"
        id="filter__all"
        class="filter__input visually-hidden"
...
class LoadMore extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/js/components/loading-message.js":
/*!**********************************************!*\
  !*** ./src/js/components/loading-message.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (LoadingMessage);
...
/* harmony default export */ __webpack_exports__["default"] = (NoTasks);


/***/ }),

/***/ "./src/js/components/search-no-result.js":
/*!***********************************************!*\
  !*** ./src/js/components/search-no-result.js ***!
  \***********************************************/
/*! exports provided: default */
...
class SearchNoResult extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return `<p class="result__empty">
      ...
      "<b>D</b>${moment__WEBPACK_IMPORTED_MODULE_1___default()(Date.now()).format(`DD.MM.YYYY`)}" - search by date</br>
    </p>`;
  }
}

/* harmony default export */ __webpack_exports__["default"] = (SearchNoResult);


/***/ }),

/***/ "./src/js/components/search-result-group.js":
/*!**************************************************!*\
  !*** ./src/js/components/search-result-group.js ***!
  \**************************************************/
/*! exports provided: default */
...
class SearchResultGroup extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/js/components/search-result-info.js":
/*!*************************************************!*\
  !*** ./src/js/components/search-result-info.js ***!
  \*************************************************/
/*! exports provided: default */
...
class SearchResultInfo extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class SearchResult extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Search extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const DEFAULT_DATE_VALUE = [moment__WEBPACK_IMPORTED_MODULE_1___default()(Date.now()).format(`DD MMM`), moment__WEBPACK_IMPORTED_MODULE_1___default()(Date.now()).add(7, `days`).format(`DD MMM`)];

class Statistics extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._tasks = [];
    this._sortedTasks = [];
    ...
    this._flatpickerInput = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(this.getElement().querySelector(`.statistic__period-input`), {
      allowInput: false,
      mode: `range`,
  ...
  _createLineChart(container, labels, chartData) {
    return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(container, {
  ...
  _createDaysChart() {
    const dayChartLabels = [...new Set(this._sortedTasks.slice()
      .sort((a, b) => moment__WEBPACK_IMPORTED_MODULE_1___default()(a.dueDate).valueOf() - moment__WEBPACK_IMPORTED_MODULE_1___default()(b.dueDate).valueOf())
      .map(({dueDate}) => moment__WEBPACK_IMPORTED_MODULE_1___default()(dueDate).format(`DD MMM`)))];
    const dayChartData = dayChartLabels.reduce((acc, label) => {
      const filteredByLabelTasks = this._sortedTasks.filter(({dueDate}) => moment__WEBPACK_IMPORTED_MODULE_1___default()(dueDate).format(`DD MMM`) === label);
  ...
  _makeDateFromValue(dateValues, format) {
    return dateValues.map((date) => moment__WEBPACK_IMPORTED_MODULE_1___default()(date, format));
  }
  ...
  _onDateInputChange() {
    this.getElement().querySelector(`.statistic__period-input`).addEventListener(`change`, () => {
      ...
      const dateValues = dateItems.map((date) => moment__WEBPACK_IMPORTED_MODULE_1___default()(date, `DD MMM`));
      const sortedByDateTasks = this._tasks.filter(({dueDate}) => moment__WEBPACK_IMPORTED_MODULE_1___default()(dueDate).isBetween(...dateValues, null, `[]`));
...
/***/ "./src/js/components/task-edit.js":
/*!****************************************!*\
  !*** ./src/js/components/task-edit.js ***!
  \****************************************/
/*! exports provided: default */
...
class TaskEdit extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor({id, description, dueDate, repeatingDays, tags, color, isFavorite, isArchive}) {
    ...
    this._isDeadLine = moment__WEBPACK_IMPORTED_MODULE_1___default()(Date.now()).subtract(1, `days`).isAfter(dueDate) && !isArchive;
...
/***/ "./src/js/controllers/board-controller.js":
/*!************************************************!*\
  !*** ./src/js/controllers/board-controller.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_board_container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/board-container */ "./src/js/components/board-container.js");
/* harmony import */ var _components_sort_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/sort.js */ "./src/js/components/sort.js");
/* harmony import */ var _components_task_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/task-list.js */ "./src/js/components/task-list.js");
/* harmony import */ var _components_load_more_button_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/load-more-button.js */ "./src/js/components/load-more-button.js");
/* harmony import */ var _components_no_tasks_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/no-tasks.js */ "./src/js/components/no-tasks.js");
/* harmony import */ var _task_list_controller_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./task-list-controller.js */ "./src/js/controllers/task-list-controller.js");
...
class BoardController {
  constructor(container, onDataChange) {
    ...
    this._boardContainer = new _components_board_container__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._sort = new _components_sort_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._taskList = new _components_task_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._loadMore = new _components_load_more_button_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._noTasks = new _components_no_tasks_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._taskListController = new _task_list_controller_js__WEBPACK_IMPORTED_MODULE_5__["default"](this._taskList.getElement(), this._onDataChange);

    this._bindedOnLoadBtnClick = this._onLoadBtnClick.bind(this);
  }

  init() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(this._container, this._boardContainer.getElement(), `beforeend`);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(this._boardContainer.getElement(), this._sort.getElement(), `beforeend`);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(this._boardContainer.getElement(), this._taskList.getElement(), `beforeend`);

    this._sort.getElement().addEventListener(`click`, (evt) => this._onSortLinkClick(evt));

    if (this._tasks.length > TASKS_IN_ROW) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(this._boardContainer.getElement(), this._loadMore.getElement(), `beforeend`);
  ...
  createTask() {
    if (this._showedTasksCount === 0) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["unrenderElement"])(this._noTasks.getElement());
  ...
  renderBoard() {
    ...
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["unrenderElement"])(this._loadMore.getElement());
    this._loadMore.removeElement();
    this._showedTasksCount = Math.min(sortedTasks.length, TASKS_IN_ROW);

    if (sortedTasks.length === 0) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["unrenderElement"])(this._sort.getElement());
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["unrenderElement"])(this._taskList.getElement());
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(this._boardContainer.getElement(), this._noTasks.getElement(), `beforeend`);
      return;
    }
  ...
  _sortByCurrentValue(tasks) {
    ...
    switch (currentSort) {
      case `date-up`:
        result = Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["sortByValue"])(tasks, `up`);
        break;
      case `date-down`:
        result = Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["sortByValue"])(tasks, `down`);
        break;
      case `default`:
        result = Object(_utils_js__WEBPACK_IMPORTED_MODULE_6__["sortByValue"])(tasks, `default`);
        break;
    }
    ...
    switch (currentFilter) {
      ...
      case FilterId.OVERDUE:
        result = result.filter(({dueDate}) => moment__WEBPACK_IMPORTED_MODULE_7___default()(Date.now()).subtract(1, `days`).isAfter(dueDate));
        break;
      case FilterId.TODAY:
...
/***/ "./src/js/controllers/page-data-controller.js":
/*!****************************************************!*\
  !*** ./src/js/controllers/page-data-controller.js ***!
  \****************************************************/
/*! exports provided: default */
...
class PageDataController {
  constructor() {
    this._newFilterComponent = new _components_filter_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  updateFilter(tasks) {
    ...
    const newFilterData = this._filterNames.map((filter) => Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getFilterData"])(filter, tasks));
...
/* harmony default export */ __webpack_exports__["default"] = (PageDataController);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_search_result_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/search-result.js */ "./src/js/components/search-result.js");
/* harmony import */ var _components_search_result_group_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/search-result-group.js */ "./src/js/components/search-result-group.js");
/* harmony import */ var _components_search_result_info_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/search-result-info.js */ "./src/js/components/search-result-info.js");
/* harmony import */ var _components_search_no_result_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/search-no-result.js */ "./src/js/components/search-no-result.js");
/* harmony import */ var _task_list_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./task-list-controller.js */ "./src/js/controllers/task-list-controller.js");
...
class SearchController {
  constructor(container, search, onBackButtonClick, onDataChange) {
    ...
    this._searchResult = new _components_search_result_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._searchResultGroup = new _components_search_result_group_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._searchResultInfo = new _components_search_result_info_js__WEBPACK_IMPORTED_MODULE_2__["default"]({});
    this._searchNoResult = new _components_search_no_result_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._taskListController = new _task_list_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](
  ...
  init() {
    ...
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._container, this._searchResult.getElement(), `beforeend`);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._searchResult.getElement(), this._searchResultGroup.getElement(), `beforeend`);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._searchResultGroup.getElement(), this._searchResultInfo.getElement(), `afterbegin`);
      ...
      .addEventListener(`keyup`, (evt) => {
        ...
        switch (value[0]) {
          ...
          case `d`:
            value = value.substring(1);
            tasks = this._tasks.filter((task) => {
              return moment__WEBPACK_IMPORTED_MODULE_6___default()(task.dueDate).format(`DD.MM.YYYY`).substring(0, value.trim().length) === value.trim();
            });
            break;
  ...
  _showSearchResult(text, tasks) {
    if (this._searchResultInfo) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["unrenderElement"])(this._searchResultInfo.getElement());
    ...
    if (tasks.length === 0) {
      ...
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["unrenderElement"])(this._searchResultInfo.getElement());
      this._searchResultInfo.removeElement();
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._searchResultGroup.getElement(), this._searchNoResult.getElement(), `afterbegin`);

    } else {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["unrenderElement"])(this._searchNoResult.getElement());
      this._searchNoResult.removeElement();

      this._searchResultInfo = new _components_search_result_info_js__WEBPACK_IMPORTED_MODULE_2__["default"]({title: text, count: tasks.length});
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["renderElement"])(this._searchResultGroup.getElement(), this._searchResultInfo.getElement(), `afterbegin`);
      this._taskListController.setTasks(tasks, tasks);
    }
  }
...
/***/ "./src/js/controllers/task-controller.js":
/*!***********************************************!*\
  !*** ./src/js/controllers/task-controller.js ***!
  \***********************************************/
...
/* harmony import */ var _components_task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/task.js */ "./src/js/components/task.js");
/* harmony import */ var _components_task_edit_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/task-edit.js */ "./src/js/components/task-edit.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils.js */ "./src/js/utils.js");
/* harmony import */ var _debounce_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../debounce.js */ "./src/js/debounce.js");
/* harmony import */ var flatpickr__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! flatpickr */ "./node_modules/flatpickr/dist/flatpickr.js");
/* harmony import */ var flatpickr__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(flatpickr__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! flatpickr/dist/flatpickr.min.css */ "./node_modules/flatpickr/dist/flatpickr.min.css");
/* harmony import */ var flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_5__);
...
class TaskController {
  constructor(container, data, mode, onChangeView, onDataChange) {
    ...
    this._taskView = new _components_task_js__WEBPACK_IMPORTED_MODULE_0__["default"](data);
    this._taskEdit = new _components_task_edit_js__WEBPACK_IMPORTED_MODULE_1__["default"](data);
  ...
  init(mode) {
    ...
    this._flatpickerInput = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(this._taskEdit.getElement().querySelector(`.card__date`), {
      allowInput: false,
    ...
    this._taskView.getElement()
      ...
      .addEventListener(`click`, (evt) => {
        Object(_debounce_js__WEBPACK_IMPORTED_MODULE_3__["debounce"])(() => {
    ...
    this._taskEdit.getElement().querySelector(`.card__delete`)
      .addEventListener(`click`, () => {
        ...
        if (mode === Mode.ADDING) {
          Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["unrenderElement"])(this._taskEdit.getElement());
    ...
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(this._container, currentView.getElement(), renderPosition);
  }
...
/***/ "./src/js/controllers/task-list-controller.js":
/*!****************************************************!*\
  !*** ./src/js/controllers/task-list-controller.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _task_controller_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./task-controller.js */ "./src/js/controllers/task-controller.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils.js */ "./src/js/utils.js");
...
class TaskListController {
  ...
  createTask() {
    ...
    this.onChangeView();
    this._creatingTask = new _task_controller_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._container, defaultTask, _task_controller_js__WEBPACK_IMPORTED_MODULE_0__["Mode"].ADDING, this.onChangeView, (...args) => {
      this._creatingTask = null;
  ...
  onChangeView() {
    ...
    if (this._container.children.length > this._showedTasksCount) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["unrenderElement"])(this._container.children[0]);
      this._creatingTask = null;
    }
  }
  ...
  _renderTask(task) {
    const taskController = new _task_controller_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._container, task, _task_controller_js__WEBPACK_IMPORTED_MODULE_0__["Mode"].DEFAULT, this.onChangeView, this._onDataChange);
    this._subscriptions.push(taskController.setDefaultView.bind(taskController));
  }
}

/* harmony default export */ __webpack_exports__["default"] = (TaskListController);
...
/* harmony default export */ __webpack_exports__["default"] = (ModelTask);
...
class Provider {
  ...
  getTasks() {
    ...
    const rawTasks = Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["objectToArray"])(rawTasksMap);
    const tasks = _model_task_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseTasks(rawTasks);
  ...
  createTask({task}) {
    ...
    return Promise.resolve(_model_task_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseTask(task));
  }
  ...
  syncTasks() {
    return this._api.syncTasks({tasks: Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["objectToArray"])(this._store.getAll())});
  }
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: sortByValue, getRandomNum, getRandomArray, POSITION, createElement, renderElement, unrenderElement, getFilterData, objectToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortByValue", function() { return sortByValue; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "unrenderElement", function() { return unrenderElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilterData", function() { return getFilterData; });
...
const getOverdueFilterCount = (tasks) => tasks.reduce((acc, {dueDate, isArchive}) =>
  (moment__WEBPACK_IMPORTED_MODULE_0___default()(Date.now()).subtract(1, `days`).isAfter(dueDate) && !isArchive ? acc + 1 : acc), 0);
...
const getFilterData = (filterName, tasks) => ({
  title: filterName,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_components_menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/components/menu.js */ "./src/js/components/menu.js");
/* harmony import */ var _js_components_search_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/components/search.js */ "./src/js/components/search.js");
/* harmony import */ var _js_components_filter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/components/filter.js */ "./src/js/components/filter.js");
/* harmony import */ var _js_controllers_board_controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/controllers/board-controller.js */ "./src/js/controllers/board-controller.js");
/* harmony import */ var _js_components_statistics_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/components/statistics.js */ "./src/js/components/statistics.js");
/* harmony import */ var _js_components_loading_message_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/components/loading-message.js */ "./src/js/components/loading-message.js");
/* harmony import */ var _js_controllers_search_controller_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/controllers/search-controller.js */ "./src/js/controllers/search-controller.js");
/* harmony import */ var _js_controllers_page_data_controller_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/controllers/page-data-controller.js */ "./src/js/controllers/page-data-controller.js");
/* harmony import */ var _js_api_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/api.js */ "./src/js/api.js");
/* harmony import */ var _js_provider_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js/provider.js */ "./src/js/provider.js");
/* harmony import */ var _js_store_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js/store.js */ "./src/js/store.js");
/* harmony import */ var _js_utils_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./js/utils.js */ "./src/js/utils.js");
...
const mainMenu = new _js_components_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
const mainSearch = new _js_components_search_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const mainFilters = new _js_components_filter_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const mainStatistics = new _js_components_statistics_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const loadingMessage = new _js_components_loading_message_js__WEBPACK_IMPORTED_MODULE_5__["default"]();

const api = new _js_api_js__WEBPACK_IMPORTED_MODULE_8__["default"]({endPoint: END_POINT, authorization: AUTHORIZATION});
const store = new _js_store_js__WEBPACK_IMPORTED_MODULE_10__["default"]({storage: window.localStorage, key: TASKS_STORE_KEY});
const boardController = new _js_controllers_board_controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](mainContainer, onDataChange);
const searchController = new _js_controllers_search_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"](mainContainer, mainSearch, onSearchBackButtonClick, onDataChange);
const pageDataController = new _js_controllers_page_data_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
const provider = new _js_provider_js__WEBPACK_IMPORTED_MODULE_9__["default"]({api, store, generateId: () => String(Date.now())});

if (!_js_provider_js__WEBPACK_IMPORTED_MODULE_9__["default"].isOnline()) {
  document.title = `${document.title} [OFFLINE]`;
}

mainStatistics.getElement().classList.add(`visually-hidden`);

Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(menuContainer, mainMenu.getElement(), `beforeend`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(mainContainer, mainSearch.getElement(), `beforeend`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(mainContainer, _js_components_filter_js__WEBPACK_IMPORTED_MODULE_2__["default"].getMockElement(), `beforeend`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(mainContainer, mainStatistics.getElement(), `beforeend`);
Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(mainContainer, loadingMessage.getElement(), `beforeend`);

provider.getTasks()
  .then((tasks) => {
    taskMainData = tasks;
    filterMainData = FILTER_NAMES.map((filter) => Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_11__["getFilterData"])(filter, tasks));
  })
  .then(() => {
  ...
  .then(() => {
    Object(_js_utils_js__WEBPACK_IMPORTED_MODULE_11__["unrenderElement"])(loadingMessage.getElement());
